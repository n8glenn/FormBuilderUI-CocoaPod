...
public class FBStyleClass: NSObject
{
    ...
    public init(with style: FBStyleClass, styleSet: FBStyleSet?)
    {
        super.init()
        ...
        let parentName = style.value(forKey: "parent") as? String ?? ""
        self.parent = styleSet?.style(named: parentName)
    }
    ...
    var font:UIFont
    {
        get
        {
            let name:String = self.value(forKey: "font-family") as? String ?? "System"
    ...
    var inputFont:UIFont
    {
        get
        {
            let name:String = self.value(forKey: "input-font-family") as? String ?? "System"
    ...
    func viewFor(type:FBFieldType) -> String
    {
        ...
        case FBFieldType.Switch:
            return self.value(forKey: "switch-view") as? String ?? "FBSwitchView"
